...
class Thread {
  ...
  public:
    ...
    int getLastTick(){ return last_tick; };
    void setLastTick(int t){ last_tick = t;}
    int getAccumulatedTime(){ return accumulated_time; };
  ...
  private:
    ...
    int exec_priority;
    int last_tick;//calculate the time entering the ready list
    /* end adding */
